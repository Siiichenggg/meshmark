...
export const STRINGS = {
  en: {
    ...
    'refs.legend': '<span class="swatch ref"></span> pink = fixed reference point (drawn, never editable)',
    'list.title': 'Objects',
    ...
    'view.plate': 'Rendering the top-down plate…',
    'view.failed': 'Could not load the mesh: {err}',
    'view.baseline': 'baseline {baseline}',
    'view.noTargets': 'no reference file',
    'plan.title': 'Top-down (click, drag)',
    'plan.scale': '{mm} mm/pixel',
    'plan.stale': 'plate is for cut height {h} m — release the slider to re-render',
  ...
  zh: {
    ...
    'routes.none': '还没有路径。',
    'refs.legend': '<span class="swatch ref"></span> 粉色 = 固定参考点（只画出来，不可编辑）',
    'list.title': '物体列表',
    'list.showRefs': '显示参考',
    'list.all': '全部',
    'list.refs': '参考',
    ...
    'plan.title': '俯视（可点、可拖）',
    'plan.scale': '{mm} 毫米/像素',
    'plan.stale': '底图对应切顶 {h} m —— 松开滑块后重渲染',
